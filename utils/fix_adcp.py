...
def main():
    ...
    try:
        ...
        send_command(ser, "SETPLAN,MIAVG=600,AVG=0,DIAVG=0,VD=0,MV=10,SA=35,BURST=1,MIBURST=1800,DIBURST=0,SV=0,FN=\"lkn04.ad2cp\",SO=0,FREQ=1000,NSTT=0", "OK")
        send_command(ser, "SETBURST,NC=22,NB=4,CS=0.4,BD=3.5,CY=\"BEAM\",PL=0,SR=2,NS=2048,VR=2.5,DF=3,NPING=7,CH=0,VR5=2.5,ALTI=1,BT=0,DISV=0,ECHO=0,RAWALTI=1,ALTISTART=0.1,ALTIEND=21.2,HR=0,HR5=0", "OK")
        send_command(ser, "SETWAVEPROC,EN=1,MOUNTHEIGHT=0.5,MODE=\"MLMST\",BANDSEPFREQ=0.2,FREQSTART=0.02,FREQEND=0.99,FREQSTEP=0.01", "OK")
