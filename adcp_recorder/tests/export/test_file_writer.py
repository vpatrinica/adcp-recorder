...
class TestFileWriter:
    ...
    def test_rotation(self, export_dir):
        ...
        with patch("adcp_recorder.export.file_writer.datetime") as mock_datetime:
            ...
            mock_datetime.now.return_value.strftime.side_effect = lambda fmt: datetime(2023, 1, 1).strftime(fmt)
            ...
            mock_datetime.now.return_value.strftime.side_effect = lambda fmt: datetime(2023, 1, 2).strftime(fmt)
