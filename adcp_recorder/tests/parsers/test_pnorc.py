...
class TestPNORC:
    def test_pnorc_parsing_basic(self):
        ...
        sentence = "$PNORC,102115,090715,1,0.1,0.2,0.3,0.4,1.5,180.0,C,100,101,102,103,90,91,92,93*11"
    ...
    def test_pnorc_validation_errors(self):
        ...
        with pytest.raises(ValueError, match="Cell index out of range"):
            PNORC.from_nmea("$PNORC,102115,090715,0,0.1,0.2,0.3,0.4,1.5,180.0,C,100,101,102,103,90,91,92,93")
        
    def test_pnorc_to_dict(self):
        msg = PNORC(
            date="102115", time="090715", cell_index=1,
            vel1=0.1, vel2=0.2, vel3=0.3, vel4=0.4,
            speed=1.5, direction=180.0, amp_unit="C",
