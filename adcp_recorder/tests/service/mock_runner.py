...
def run_mock_service():
    ...
    with patch('adcp_recorder.service.supervisor.AdcpRecorder', return_value=mock_recorder) as MockRec, \
         patch('adcp_recorder.service.supervisor.RecorderConfig') as MockConf:
        
        # Setup config defaults
        mock_config = MockConf.load.return_value
